...
python query_processing.py kl_divergence 
...
Chriss-MacBook-Pro-3:InfoRetrieval Chris$ python query_processing.py kl_divergence stem_index
setting up
ranking query results by kl_divergence
default index: stem_index
no_phrases set to False
POSITIONAL_TRESHOLD: 20
PHRASE_THRESHOLD: 20
processing
query number: 372
query 1/21
using defualt index stem_index with retrieved docs of count 140
query number: 288
query 2/21
using defualt index stem_index with retrieved docs of count 634
query number: 371
query 3/21
using defualt index stem_index with retrieved docs of count 474
query number: 350
query 4/21
passed positional threshold of 20 found 121, scoring on positional index
